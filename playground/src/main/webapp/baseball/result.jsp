...
//String log = "<b>"+guess[0]+" "+guess[1]+" "+guess[2]+"</b> <b>" + strike+"S</b> <b>" + ball+"B</b>";
...
<body>
	<div style="text-align: center;">
		...
		<p>
			제시한 숫자
			<b style="font-size: 18pt;">[<%=guess[0] %>] [<%=guess[1] %>] [<%=guess[2] %>]</b> 의 결과를 알려드립니다.
		</p>
		<%if(strike ==0 && ball ==0) { %>
		...
		<%}else { %>
			<p style="font-size:52pt">
				<b style="color: hotpink;"><%=strike %>S</b>
				<b style="color:cornflowerblue;"><%=ball %>B</b>
			</p>
