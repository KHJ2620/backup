	...
	<div style="width: 840px; margin: 0 auto;">
		...
		<div style="width: 400px; margin: 60px auto; border:2px solid #ddd; padding:30px;">
			<form action="<%=application.getContextPath() %>/member/login-handle.jsp">
				<p>
					<input type="text" class ="login-input" name="u_id" placeholder="아이디를 입력해주세요" />
				</p>
				<p>
					<input type="password" class ="login-input" name="u_pwd" placeholder="비밀번호를 입력해주세요"/>
				</p>
				<p>
			...
			<p style="text-align:center">
				<a href="<%=application.getContextPath() %>/member/join/.jsp">신규회원가입 바로가기</a>
			</p>
