...
<body>
	...
	<p><%=id %> 
		application 이라는 내장객체는 ServletContext 객체로, 웹 어플리케이션 전반에 걸친 정보 및 설정을 확인하거나
		변경하고자 할 때 사용되는 객체이다. 
		이 application 객체는 서버가 이 웹 어플리케이션에 부여되는 객체이다.(만들어지는 건 서버가 켜지면서) 
	</p>
	<p>
	...
	<ul>
		...
		<li>getContextPath() : <%=application.getContextPath() %> : 웹 어플리케이션의 컨텍스트 경로 </li>
	</ul>
	<h4>컨텍스트 초기화 파라미터 관련 메서드</h4>
	<ul>
