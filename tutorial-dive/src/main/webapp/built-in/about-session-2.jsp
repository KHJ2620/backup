...
<body>
	<h2>클라이언트 세션 활용</h2>
	<p>
		클라이언트들은 자기 의지와 상관없이 무조건 세션을 할당받게 돼있다.
		이 세션을 활용해서 사용자별로 개별 상태를 관리할 수 있게 된다.
	</p>
	<p>
		...
		<small>(세션에는 숫자도 저장해야 될 수도 있고, 문자열도 저장해야 될 수도 있기 때문에 
		제너릭을 String, Object 로 처리해둠. 그렇기 때문에 get 을 할 때 캐스팅해서 추출)</small>
	</p>
	<p>
		이 요청을 보낸 사용자의 세선에 저장된 visited 값 : <%=value %>
	</p>
</body>
</html>